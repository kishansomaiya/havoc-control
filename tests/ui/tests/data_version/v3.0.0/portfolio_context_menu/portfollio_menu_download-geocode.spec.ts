...
test.describe('Portfolio context menu - Download GeoCode', () => {
  ...
  test('Verify portfolio download geocode option', async ({
    portfolioList,
    portfolioItem,
    ...
    await portfolioItemMenuDropDown.verifyDownloadedGeocodeLog(portfolioName);
  });
});
