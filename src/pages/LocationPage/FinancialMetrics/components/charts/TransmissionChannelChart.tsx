...
interface TransmissionChannelChartProps extends ComponentProps<typeof Box> {
    yearsRange: number[];
    graphData: LocationFinancialMetricsGraphData[];
    yAxisLabel: string;
}

export const TransmissionChannelChart: FC<TransmissionChannelChartProps> = ({
    yearsRange,
    graphData,
    yAxisLabel,
    ...props
    ...
    const series = useMemo(() => {
        return graphData
            ...
            .map((seriesData) => ({ ...seriesData, stack: 'transmission' }));
    }, [graphData]);
    ...
    return (
        <Box
            ...
            {...props}
            data-testid="slp-financial-metrics-graph-transmission-channel"
        >
            <Typography
                variant="overline"
