...
const EntityManager = () => {
  ...
  const activeEntity = useAppSelector((state: any) => state.app.activeEntity);
  const { data: entitiesData, error: entitiesError, isLoading: entitiesLoading } = useGetEntityQuery(activeEntity || 'sector');
